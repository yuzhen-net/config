...
set -x
ip route add 172.23.33.203/32 dev lo proto 114 table 114 scope link
...
ip addr add 172.23.33.203/32 dev int-hk-hkg-4
ip addr add 2a12:dd47:83e0:b::1/128 dev int-hk-hkg-4
ip addr add fe80::2399:b/64 dev int-hk-hkg-4 scope link
...
ip addr add 172.23.33.203/32 dev int-us-nyc-4
ip addr add 2a12:dd47:83e0:b::1/128 dev int-us-nyc-4
ip addr add fe80::2399:b/64 dev int-us-nyc-4 scope link
...
ip addr add 172.23.33.203/32 dev int-au-nsw-4
ip addr add 2a12:dd47:83e0:b::1/128 dev int-au-nsw-4
ip addr add fe80::2399:b/64 dev int-au-nsw-4 scope link
...
ip addr add 172.23.33.203/32 dev int-uk-lon-4
ip addr add 2a12:dd47:83e0:b::1/128 dev int-uk-lon-4
ip addr add fe80::2399:b/64 dev int-uk-lon-4 scope link
...
ip addr add 172.23.33.203/32 dev int-cn-pek-4
ip addr add 2a12:dd47:83e0:b::1/128 dev int-cn-pek-4
ip addr add fe80::2399:b/64 dev int-cn-pek-4 scope link
...
ip addr add 172.23.33.203/32 dev int-nl-ams-4
ip addr add 2a12:dd47:83e0:b::1/128 dev int-nl-ams-4
ip addr add fe80::2399:b/64 dev int-nl-ams-4 scope link
...
ip addr add 172.23.33.203/32 dev int-cn-csx-4
ip addr add 2a12:dd47:83e0:b::1/128 dev int-cn-csx-4
ip addr add fe80::2399:b/64 dev int-cn-csx-4 scope link
...
ip addr add 172.23.33.203/32 dev int-us-sea-4
ip addr add 2a12:dd47:83e0:b::1/128 dev int-us-sea-4
ip addr add fe80::2399:b/64 dev int-us-sea-4 scope link
