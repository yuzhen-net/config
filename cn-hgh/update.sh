...
if get_ip_down "fe80::2399:1" "int-hk-hkg-4"; then
    update_wg_peer int-hk-hkg-4 "xE7n63bfDpppBBlm19eung9ZBoXdMDCMbIA81gezhBY=" "$ip_hk_hkg_4:18001" "igp_tunnels/int-hk-hkg-4.conf"
fi
if get_ip_down "fe80::2399:2" "int-us-nyc-4"; then
    update_wg_peer int-us-nyc-4 "qZcGPPoSDfNhUNhTUgllJ901cN7BnSm19esv/rO2qzQ=" "$ip_us_nyc_4:18002" "igp_tunnels/int-us-nyc-4.conf"
fi
if get_ip_down "fe80::2399:3" "int-au-nsw-4"; then
    update_wg_peer int-au-nsw-4 "LiDzHat2kywF2qqn7X5giRIabNMsF5STFQ9KCXGfeFg=" "$ip_au_nsw_4:18003" "igp_tunnels/int-au-nsw-4.conf"
fi
if get_ip_down "fe80::2399:4" "int-uk-lon-4"; then
    update_wg_peer int-uk-lon-4 "MnAoon9Gsh/Vsbl7P0SRoGU290FMTugschWBmhNXjRU=" "$ip_uk_lon_4:18004" "igp_tunnels/int-uk-lon-4.conf"
fi
if get_ip_down "fe80::2399:5" "int-cn-pek-4"; then
    update_wg_peer int-cn-pek-4 "rKY7I17fjuANn5+rfSnFLm8EpsRMFNj1nz/AjWA6vwc=" "$ip_cn_pek_4:18006" "igp_tunnels/int-cn-pek-4.conf"
fi
if get_ip_down "fe80::2399:7" "int-nl-ams-4"; then
    update_wg_peer int-nl-ams-4 "DkbI8OjJW33OjPpYZa8iG1718vfbKVZdHMrB+0RyT2k=" "$ip_nl_ams_4:18006" "igp_tunnels/int-nl-ams-4.conf"
fi
if get_ip_down "fe80::2399:8" "int-cn-csx-4"; then
    update_wg_peer int-cn-csx-4 "igenKeX0BhyLY/VGlP7ZmbGUQsIYcjsnXgcIVSnKDTg=" "$ip_cn_csx_4:18008" "igp_tunnels/int-cn-csx-4.conf"
fi
if get_ip_down "fe80::2399:9" "int-us-sea-4"; then
    update_wg_peer int-us-sea-4 "arG1USG6tq16NucquEQcClFu3nwLbC3ZVJeqFI6UOjc=" "$ip_us_sea_4:18008" "igp_tunnels/int-us-sea-4.conf"
fi
