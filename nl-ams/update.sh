...
if get_ip_down "fe80::2399:8" "int-cn-csx-4"; then
    update_wg_peer int-cn-csx-4 "igenKeX0BhyLY/VGlP7ZmbGUQsIYcjsnXgcIVSnKDTg=" "$ip_cn_csx_4:18005" "igp_tunnels/int-cn-csx-4.conf"
fi
if get_ip_down "fe80::2399:9" "int-us-sea-4"; then
    update_wg_peer int-us-sea-4 "arG1USG6tq16NucquEQcClFu3nwLbC3ZVJeqFI6UOjc=" "$ip_us_sea_4:18005" "igp_tunnels/int-us-sea-4.conf"
fi
